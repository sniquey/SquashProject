...
m6 = Match.create(:date => Date.parse("04/10/2014"), :loser_id => 22464, :winner_id => 54115, :winner_games => 1, :loser_games => 0, :winner_points => 40, :loser_points => 28,	:loser_matrix_change => 0.02, :winner_matrix_change => 0.64, :loser_before_matrix => 258.11, :winner_before_matrix => 276.76)
